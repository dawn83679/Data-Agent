...
export const MEMORY_DEFAULT_CONFIDENCE_SCORE = '0.9';
export const MEMORY_DEFAULT_SALIENCE_SCORE = '0.6';
...
export const MEMORY_WORKSPACE_SCOPE = MEMORY_SCOPE_OPTIONS[1];
...
export const MEMORY_SCORE_INPUT_STEP = '0.01';

export const MEMORY_STATUS_TONE_CLASS_NAMES = {
  [MEMORY_STATUS.ACTIVE]: 'bg-emerald-500/12 text-emerald-300 border-emerald-500/25',
  [MEMORY_STATUS.ARCHIVED]: 'bg-amber-500/12 text-amber-300 border-amber-500/25',
  [MEMORY_STATUS.HIDDEN]: 'bg-slate-500/12 text-slate-300 border-slate-500/25',
} as const;
