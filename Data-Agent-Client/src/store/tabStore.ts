...
import type { ConsoleTabMetadata, PlanTabMetadata, TableTabMetadata, WorkspaceTabMetadata } from '../types/tab';
...
interface TabState {
  ...
  updateTabMetadata: (id: string, metadata: Partial<ConsoleTabMetadata | TableTabMetadata>) => void;
