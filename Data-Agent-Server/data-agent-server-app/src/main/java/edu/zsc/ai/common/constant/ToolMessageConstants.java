...
public final class ToolMessageConstants {
    ...
    public static final String EMPTY_NO_PROCEDURES = "EMPTY: No procedures found.";

    /** Returned when getTriggerNames returns no triggers. */
    public static final String EMPTY_NO_TRIGGERS = "EMPTY: No triggers found for this table.";

    /** Returned when getIndexes returns no indexes. */
    public static final String EMPTY_NO_INDEXES = "EMPTY: No indexes found for this table.";
