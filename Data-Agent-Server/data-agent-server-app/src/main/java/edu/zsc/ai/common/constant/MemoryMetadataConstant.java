...
public final class MemoryMetadataConstant {
    ...
    public static final String WORKSPACE_LEVEL = "workspaceLevel";
    public static final String WORKSPACE_CONTEXT_KEY = "workspaceContextKey";
    ...
    private MemoryMetadataConstant() {
    }
}
